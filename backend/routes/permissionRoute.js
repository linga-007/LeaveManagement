...
const {checkPermission,ApplyPermission,AcceptPermission,Accept,DenyPermission,Deny,updatePermission,GetPermission} = require('../controllers/permissionController');
